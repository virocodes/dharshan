...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Social Links */}
      <div className="fixed top-8 right-8 z-50 flex gap-6">
        <motion.a
        ...
        >
          ...
          <div className="relative bg-black/80 backdrop-blur-sm px-4 py-2 rounded-lg font-medium text-white flex items-center gap-2">
        ...
        >
          ...
          <div className="flex gap-4 justify-center">
            ...
            >
              ...
              <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-3 rounded-lg font-semibold text-white">
                check out my work
              </div>
            </motion.button>
            <motion.button
            ...
            >
              ...
              <div className="relative bg-black/40 backdrop-blur-sm px-8 py-3 rounded-lg font-semibold text-white border border-white/10">
                view resume
              </div>
            </motion.button>
          </div>
      ...
      {/* Projects Section */}
      <section id="projects" className="relative pt-32">
                  ...
                  <div className="p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        <span className="px-3 py-1 bg-blue-600/20 backdrop-blur-sm rounded-full text-sm border border-blue-500/50">Next.js</span>
                        <span className="px-3 py-1 bg-purple-600/20 backdrop-blur-sm rounded-full text-sm border border-purple-500/50">Tailwind</span>
                        <span className="px-3 py-1 bg-green-600/20 backdrop-blur-sm rounded-full text-sm border border-green-500/50">Supabase</span>
                        <span className="px-3 py-1 bg-yellow-600/20 backdrop-blur-sm rounded-full text-sm border border-yellow-500/50">Vapi</span>
                        <span className="px-3 py-1 bg-red-600/20 backdrop-blur-sm rounded-full text-sm border border-red-500/50">Gemini</span>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      ...
                      >
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200" />
                        <div className="relative bg-black/40 backdrop-blur-sm px-6 py-2 rounded-lg font-semibold text-white/50 border border-white/10">
                          Coming Soon
                        </div>
                      </motion.button>
                    </div>
                ...
                <div className="grid lg:grid-cols-3">
                  ...
                  <div className="p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        <span className="px-3 py-1 bg-blue-600/20 backdrop-blur-sm rounded-full text-sm border border-blue-500/50">Next.js</span>
                        <span className="px-3 py-1 bg-purple-600/20 backdrop-blur-sm rounded-full text-sm border border-purple-500/50">Shadcn</span>
                        <span className="px-3 py-1 bg-green-600/20 backdrop-blur-sm rounded-full text-sm border border-green-500/50">Tailwind</span>
                        <span className="px-3 py-1 bg-yellow-600/20 backdrop-blur-sm rounded-full text-sm border border-yellow-500/50">Lucid</span>
                        <span className="px-3 py-1 bg-red-600/20 backdrop-blur-sm rounded-full text-sm border border-red-500/50">Drizzle</span>
                        <span className="px-3 py-1 bg-indigo-600/20 backdrop-blur-sm rounded-full text-sm border border-indigo-500/50">Neon</span>
                        <span className="px-3 py-1 bg-pink-600/20 backdrop-blur-sm rounded-full text-sm border border-pink-500/50">Vercel Blob</span>
                        <span className="px-3 py-1 bg-emerald-600/20 backdrop-blur-sm rounded-full text-sm border border-emerald-500/50">OpenAI</span>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <motion.a
                      ...
                      >
                        <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                        <div className="relative bg-black/80 backdrop-blur-sm px-6 py-2 rounded-lg font-semibold text-white">
                          View Code
                        </div>
                      </motion.a>
                    </div>
                  ...
                  <div className="p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        <span className="px-3 py-1 bg-blue-600/20 backdrop-blur-sm rounded-full text-sm border border-blue-500/50">Next.js</span>
                        <span className="px-3 py-1 bg-purple-600/20 backdrop-blur-sm rounded-full text-sm border border-purple-500/50">Tailwind</span>
                        <span className="px-3 py-1 bg-green-600/20 backdrop-blur-sm rounded-full text-sm border border-green-500/50">Firebase</span>
                        <span className="px-3 py-1 bg-yellow-600/20 backdrop-blur-sm rounded-full text-sm border border-yellow-500/50">HuggingFace</span>
                        <span className="px-3 py-1 bg-red-600/20 backdrop-blur-sm rounded-full text-sm border border-red-500/50">SDXL-Turbo</span>
                        <span className="px-3 py-1 bg-indigo-600/20 backdrop-blur-sm rounded-full text-sm border border-indigo-500/50">Modal</span>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <motion.a
                ...
                <div className="grid lg:grid-cols-3">
                  ...
                  <div className="p-8 flex flex-col justify-between">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-6">
                        <span className="px-3 py-1 bg-blue-600/20 backdrop-blur-sm rounded-full text-sm border border-blue-500/50">React</span>
                        <span className="px-3 py-1 bg-purple-600/20 backdrop-blur-sm rounded-full text-sm border border-purple-500/50">Tailwind</span>
                        <span className="px-3 py-1 bg-green-600/20 backdrop-blur-sm rounded-full text-sm border border-green-500/50">Node.js</span>
                        <span className="px-3 py-1 bg-yellow-600/20 backdrop-blur-sm rounded-full text-sm border border-yellow-500/50">Express</span>
                        <span className="px-3 py-1 bg-red-600/20 backdrop-blur-sm rounded-full text-sm border border-red-500/50">Puppeteer</span>
                        <span className="px-3 py-1 bg-indigo-600/20 backdrop-blur-sm rounded-full text-sm border border-indigo-500/50">Cheerio</span>
                      </div>
                    </div>
                    <div className="flex gap-4">
                      <motion.a
          ...
          >
            ...
            <div className="mb-12">
              <div>
                ...
                <p className="text-gray-400 mb-3">MandrakeTech • Remote</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div>
              <div>
                ...
                <p className="text-gray-400 mb-3">S#AI • Remote</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
          ...
          >
            ...
            <div>
              <div>
                ...
                <p className="text-gray-400 mb-3">Team Project (~32 hours)</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
          ...
          >
            ...
            <div className="mb-12">
              <div>
                ...
                <p className="text-gray-400 mb-3">Team Project (~30 hours)</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div className="mb-12">
              <div>
                ...
                <p className="text-gray-400 mb-3">Published Web-App 20 Users (~30 hours)</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
            ...
            <div>
              <div>
                ...
                <p className="text-gray-400 mb-3">Published Web-App 50 Users (~40 hours)</p>
                <ul className="list-disc list-inside text-gray-300 space-y-2">
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg blur opacity-25 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
            <div className="relative bg-black/80 backdrop-blur-sm p-12 rounded-lg border border-gray-800">
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200" />
                <div className="relative bg-black/80 backdrop-blur-sm px-8 py-3 rounded-lg font-semibold text-white inline-flex items-center gap-2">
